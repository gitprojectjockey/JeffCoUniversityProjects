...
namespace JeffCoUniversity.API.Controllers
{
    ...
    public class InstructorController : ApiController
    {
        ...
        [HttpPost]
        [Route("Range")]
        public IHttpActionResult Create([System.Web.Mvc.Bind(Include = "Id,LastName,FirstName,HireDate,Courses")] IEnumerable<InstructorWithCoursesIn> instructorsWithCoursesIn)
        {
